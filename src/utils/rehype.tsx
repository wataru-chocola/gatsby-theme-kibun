...
const H1 = (props: any) => (
  <Typography variant="h3" component="h2" {...props}></Typography>
);

const H2 = (props: any) => (
  <Typography variant="h4" component="h2" {...props}></Typography>
);
...
const H5 = (props: any) => (
  <Typography variant="h6" component="h5" {...props}></Typography>
);

const H6 = (props: any) => {
  const classes = useStyles();
  return (
    <Typography variant="h6" component="h6" className={classes.h6} {...props}></Typography>
  );
};
